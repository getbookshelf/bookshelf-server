...
if(!empty($id)) {
    ...
    echo '<p><a href="download.php?id=' . $id .'">Download book</a><br><a href="read.php?id=' . $id .'">Read book online</a><br><a href="edit-book.php?id=' . $id .'">Edit book</a><br><a href="#" onclick="deleteBook(\'' . $base_url . '\', ' . $id .');return false;">Delete book</a></p>';
}
else {
